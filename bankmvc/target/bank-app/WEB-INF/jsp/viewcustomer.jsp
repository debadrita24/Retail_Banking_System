...
<html>
  <head>
    ...
    <style>
      ...
      body {
        ...
        color: white;
        background: linear-gradient(to right, #ef9a9a, #3f51b5);
      }
      ul {
  ...
  <body>
    ...
    response.setDateHeader("Expires", 0); if (session.getAttribute("token") ==
    null) { %>
    <c:redirect url="/403" />
    <% } %>
    <div align="center">
    ...
    <div style="margin: 9em 120em 14em 14em">
      ...
      >
        <div class="card-body">
          ...
          <br /><br />
          <div align="center"><br /><a href="/dashboard">Back</a></div>
        </div>
      </div>
    </div>
  </body>
